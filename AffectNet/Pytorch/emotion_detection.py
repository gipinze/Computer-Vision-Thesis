...
# HOW TO RUN
# Code line for analyze video
# python emotion_detection.py -v video/novak_djokovic.mp4 --model output/model.pth --prototxt model/deploy.prototxt.txt --caffemodel model/res10_300x300_ssd_iter_140000_fp16.caffemodel

# Code line to analyze webcam
# python emotion_detection.py --model output/model.pth --prototxt model/deploy.prototxt.txt --caffemodel model/res10_300x300_ssd_iter_140000_fp16.caffemodel

# Code line to analyze webcam
# python emotion_detection.py -i images/happyMan.jpg --model output/model.pth --prototxt model/deploy.prototxt.txt --caffemodel model/res10_300x300_ssd_iter_140000_fp16.caffemodel

# initialize the argument parser and establish the arguments required
parser = argparse.ArgumentParser()
# parser.add_argument("-v", "--video", type=str, required=True,
#                     help="path to the video file/ webcam")
# parser.add_argument("-i", "--image", type=str, required=True, help="Path to the desired image")
parser.add_argument("-k", "--camera", type=int, default=0, help="The camera number to use")
...
emotion_dict = {0: "Angry", 1: "Contempt" , 2: "Disgust", 3: "Fear", 4: "Happy",
