...
"""
Face and eye detection using opencv (Haar Cascade classification)
...
#face_cascade = cv2.CascadeClassifier('cascade_frontal.xml')
#eye_cascade = cv2.CascadeClassifier('haarcascades_models/haarcascade_eye.xml')

img = cv2.imread('images/anime3.jpg')
...
"""faces = face_cascade.detectMultiScale(
    gray, 
    scaleFactor = 1.3, 
    minNeighbors = 7) #scaleFactor = 1.3, minNeighbors = 7 works with human faces better
