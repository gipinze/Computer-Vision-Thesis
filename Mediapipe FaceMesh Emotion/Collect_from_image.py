...
def encode_label(label_name, category):
    for i in category:
        if i == label_name:
            label_index = category.index(i)
            print(f"Label name: {label_name}, Label index: {label_index}")
            return label_index
    print(f"Label name: {label_name}, Label index not found")
    return None
...
root = r"C:/Users/darks/Desktop/Emotion AI/Emotion Recognition/DATASETS/AffectNet/train/"
IMAGE_FILES = []
